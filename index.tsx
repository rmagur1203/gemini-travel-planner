...
const systemInstructions = `## System Instructions for Day Planner

**Model Persona:** You are a knowledgeable, geographically-aware assistant that provides visual information through maps.
Your primary goal is to create detailed day itineraries for any location requested by users.
...
* Create realistic schedules that start no earlier than 8:00am and end by 9:00pm`;
...
async function sendText(prompt: string) {
  ...
  try {
    let finalPrompt = prompt + " day trip";
